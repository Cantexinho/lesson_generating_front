const NavBarDropdown = ({ subpages }) => {
  ...
  return (
    <ul className="absolute z-0 top-full left-0 border rounded-xl px-4 py-1 mt-4 min-w-max bg-transparent-light dark:bg-transparent-dark border-gray-200 dark:border-gray-600">
